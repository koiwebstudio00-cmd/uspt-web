...
const PosgradoTemplate = ({
    ...
    const img_url = posgrado.featured_img ?? "/images/posgrado.webp";

    const quickFacts = [
        { icon: GraduationCap, label: "Tipo", value: posgrado.tipo },
        { icon: Globe, label: "Modalidad", value: posgrado.modalidad },
        {
            icon: MapPin,
            label: "Sede",
            value: posgrado.sede || "Campus Central",
        },
        {
            icon: Clock,
            label: "Duración",
            value: `${posgrado.duration} ${posgrado.duration === 1 ? "año" : "años"}`,
        },
    ];
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <main>
                ...
                {(posgrado.description || posgrado.perfil_egresado) && (
