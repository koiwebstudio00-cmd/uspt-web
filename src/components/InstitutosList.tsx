                        ...
                        {institutos.map((instituto, index) => {
                            ...
                            return (
                                <Card
                                    ...
                                    className={`order-last border-0 bg-transparent shadow-none sm:order-first sm:col-span-12 lg:col-span-10 lg:col-start-2 animate-on-scroll font-heading font-medium ${cardRef.isIntersecting ? "animate-fade-in-up" : ""
                                        }`}
                                >
                                    <div className="grid gap-y-6 sm:grid-cols-10 sm:gap-x-5 sm:gap-y-0 md:items-center md:gap-x-8 lg:gap-x-12">
                                        <div className="sm:col-span-5">
                                            <h3 className="text-xl font-heading font-semibold md:text-2xl lg:text-3xl ">
                                                <Link
                                                    to={instituto.link}
                                        ...
                                        <div className="order-first sm:order-last sm:col-span-5">
                                            ...
                                            >
                                                <div className="aspect-video border-border overflow-hidden border max-h-[150] relative">
                                                    <img
                                                        src={instituto.src}
                                                        alt={instituto.title}
                                                        className="fade-in h-full w-full object-cover transition-transform duration-500 group-hover/img:scale-105"
                                                    />
