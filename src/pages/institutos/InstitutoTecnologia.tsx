...
// ID del Instituto de Desarrollo e Innovación Tecnológica para la Competitividad Territorial
const INSTITUTO_TECNOLOGIA_ID = 5;

const InstitutoTecnologia = () => {
    const { instituto, carreras, loading, error } = useInstitutoById(
        INSTITUTO_TECNOLOGIA_ID
    );
...
export default InstitutoTecnologia;
