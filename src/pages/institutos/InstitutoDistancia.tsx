...
// ID del Instituto de Educación a Distancia y Tecnología Educativa
const INSTITUTO_DISTANCIA_ID = 6;

const InstitutoDistancia = () => {
    const { instituto, carreras, loading, error } = useInstitutoById(
        INSTITUTO_DISTANCIA_ID
    );
...
export default InstitutoDistancia;
