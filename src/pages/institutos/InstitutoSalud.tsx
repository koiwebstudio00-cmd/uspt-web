...
// ID del Instituto de Salud y Calidad de Vida
const INSTITUTO_SALUD_ID = 4;

const InstitutoSalud = () => {
    const { instituto, carreras, loading, error } =
        useInstitutoById(INSTITUTO_SALUD_ID);
