                ...
                {/* <section className="py-20 bg-muted/20">
                    <div className="container mx-auto px-4 text-center">
                        ...
                        <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-10 font-body">
                            Explorá nuestras publicaciones académicas y de
                            investigación.
                        </p>
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {[1, 2, 3].map((item) => (
                                <div
                                    key={item}
                                    className="bg-white p-6 rounded-2xl shadow-sm border border-muted2 hover:shadow-md transition-shadow"
                                >
                                    ...
                                    <p className="text-muted-foreground text-sm mb-4">
                                        Investigación y desarrollo académico de
                                        nuestra universidad.
                                    </p>
                                    <a
                                        href="#"
