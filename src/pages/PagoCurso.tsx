...
const PagoCurso = () => {
    ...
    const handlePago = async () => {
        ...
        if (!curso) {
            setPaymentError("Información de curso no disponible");
            return;
        }
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/payment/enroll-course`, {
                method: "POST",
                headers: {
        ...
        return (
            <div className="min-h-screen bg-background flex flex-col">
                ...
                <div className="flex-1 flex flex-col items-center justify-center p-4">
                    ...
                    <Button asChild>
                        <Link to="/extension-universitaria">
                            Volver a cursos
                        </Link>
                    </Button>
                </div>
        ...
        <div className="min-h-screen bg-background">
            ...
            <main>
                <HeroPageComponent
                    ...
                    description={`Completá tus datos para inscribirte en: ${curso.fullname || curso.displayName}`}
                                    ...
                                    <div className="text-center space-y-4">
                                        <div>
                                            ...
                                            <p className="text-sm text-muted-foreground mt-1">
                                                * Se enviarán los datos de
                                                acceso a tu casilla de correo
