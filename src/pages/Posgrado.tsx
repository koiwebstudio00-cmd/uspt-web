                ...
                {loading ? (
                    ...
                    <div className="text-center py-20">
                        <p className="text-muted-foreground">
                            Error al cargar los programas de posgrado
                        </p>
                    </div>
                ) : (
                    <>
                        ...
                        {/* Maestrías Section */}
                        {maestrias.length > 0 && (
                            <section className="bg-[#FAFCFD] py-16">
                                <div className="container mx-auto px-4">
                                    <div className="text-center mb-16">
                                        <h2 className="text-3xl md:text-5xl font-heading font-medium text-foreground mb-6">
                                            Maestrías
                            ...
                            <section className="py-20 bg-white">
                                <div className="container mx-auto px-4">
                                    <div className="text-center mb-16">
                                        ...
                                        <p className="text-xl text-muted-foreground font-body leading-relaxed max-w-3xl mx-auto">
                                            Cursos de posgrado para actualizar y
                                            profundizar conocimientos en áreas
                                            específicas
                                        </p>
                                    </div>
